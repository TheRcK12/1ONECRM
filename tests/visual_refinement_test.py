...
assert VERSION["version"] == "2.6.7-beta.1"
assert "APP_VERSION = \"2.6.7-beta.1\"" in (ROOT / "one_crm_server.py").read_text(encoding="utf-8")
...
assert "app.css?v=2.6.7" in INDEX
assert "app.js?v=2.6.7" in INDEX
